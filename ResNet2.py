...
class ImageRecognition(object):
    def __init__(self):
        ...
        self.LAYERS = 18  # The number of layers
    ...
    def __inference(self, images):
        ...
        h = images
        h = self.__activation(self.__batch_normalization(self.__conv(h, 16)))
        ...
        h = self.__dense(h, self.NUM_CLASSES)
...
if __name__ == "__main__":
    ...
    tf.app.flags.DEFINE_string('train_dir', 'result/ResNet2/train_result',
                               """Directory where to write event logs and checkpoint.""")
    tf.app.flags.DEFINE_integer('max_steps', 100000, """Number of batches to run.""")
    tf.app.flags.DEFINE_boolean('log_device_placement', False, """Whether to log device placement.""")
    tf.app.flags.DEFINE_string('eval_dir', 'result/ResNet2/eval_result', """Directory where to write event logs.""")
    tf.app.flags.DEFINE_string('eval_data', 'test', """Either 'test' or 'train_eval'.""")
    tf.app.flags.DEFINE_string('checkpoint_dir', 'result/ResNet2/train_result',
