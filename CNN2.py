...
if __name__ == "__main__":
    ...
    learn_data = 'result/CNN2/cifar_10'
    final_accuracy = 0
    batch_size = 50
    ...
    util.create_file('result/CNN2/submission.csv')
    ...
    for i in range(0, X_test.shape[0], batch_size):
        ...
        util.append_data_to_file('result/CNN2/submission.csv', predicted_labels, i)
